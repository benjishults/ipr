        ...
        with(
            ...
            "testValidStartFormula" - {
                listOf(
                    ...
                    TestValidStartFormula(And::class, "(and (P) (Q x))", "(AND (P) (Q x))", 15),
                    TestValidStartFormula(Or::class, "(or (P) (Q x))", "(OR (P) (Q x))", 14),
                    TestValidStartFormula(Implies::class, "(implies (P) (Q x))", "(IMPLIES (P) (Q x))", 19),
                    TestValidStartFormula(Iff::class, "(iff (P) (Q x))", "(IFF (P) (Q x))", 15),
